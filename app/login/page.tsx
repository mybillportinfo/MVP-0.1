        ...
        <div className="bg-slate-800/50 rounded-2xl p-8 border border-slate-700">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm">Sign in to mu<span className="text-teal-500 italic">billport</span></p>
            </div>
          </div>
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="bg-slate-800/50 px-4 text-slate-500">or sign in with email</span>
            </div>
          </div>
