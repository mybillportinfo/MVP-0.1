...
export default function Header({ userName, showNotifications = true, onLogout }: HeaderProps) {
  return (
    <header className="bg-gradient-to-br from-teal-400 via-teal-500 to-emerald-500 text-white">
            ...
            <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center shadow-sm">
              <img 
                ...
                onError={(e) => {
                  ...
                  e.currentTarget.parentElement!.innerHTML = '<span class="text-teal-600 font-bold text-lg">M</span>';
                }}
              />
            </div>
            <span className="text-xl font-bold">
              <span className="text-white">MyBill</span>
              <span className="text-emerald-100">Port</span>
            </span>
          </div>
          <div className="flex items-center space-x-2">
            {showNotifications && (
